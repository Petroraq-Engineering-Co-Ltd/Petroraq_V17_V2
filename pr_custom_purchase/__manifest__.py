# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'portal', 'product', 'hr', 'mail', 'web', 'purchase', 'purchase_stock', 'stock', 'bus',
                'project', 'account', 'account_budget', 'pr_account', 'pr_base', 'prt_report_attachment_preview'],
    'data': [
        ...
        'views/purchase_order_advance_payment_views.xml',
        'views/rfq_comparison_wizard.xml',
        'views/res_users_supervisor.xml',
        'views/stock_picking_approval_views.xml',
        'views/budgetary_rfq_email.xml',
        'views/purchase_payment_terms.xml',
